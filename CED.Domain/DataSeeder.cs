...
public class DataSeeder
{
    ...
    private void SeedData()
    {
        ...
        var tutorUser = new User
        {
            ...
            PhoneNumber = "0123123120", Email = "20520727@gm.uit.edu.com", Role = UserRole.Tutor
        };
        ...
        {
            Id = Guid.NewGuid(),
            FirstName = "Yan", LastName = "Woo", 
            Gender = Gender.Female, Description = "Multi-subject tutor",
