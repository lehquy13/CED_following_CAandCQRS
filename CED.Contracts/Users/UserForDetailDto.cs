...
public class UserForDetailDto : FullAuditedAggregateRootDto<Guid>
{
    //User information
    ...
    public string Role { get; set; } = Domain.Shared.ClassInformationConsts.UserRole.Learner.ToString();
